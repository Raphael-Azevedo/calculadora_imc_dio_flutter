...
import 'new_weight_controller_test.mocks.dart';
...
void main() async {
  late NewWeightPageController controller;
  late MockBuildContext mockBuildContext;
  late MockNavigatorObserver mockNavigator;

  setUp(() {
    controller = NewWeightPageController();
    ...
    testWidgets('Make sure a push occurs on method goToResultPage when called',
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          initialRoute: '/newWeight',
          routes: {
            '/newWeight': (context) => Builder(builder: (context) {
